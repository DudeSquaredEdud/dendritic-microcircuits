...
class Experiment:
    def __init__(self, params: MultiDict):
        ...
        self._beta = params.get(
            "beta", 1.0 / 3.0, type=float
        ...
        self.layers: List[Layer] = (
            []
        )  # list is made of layers. List type assists code completion.
    ...
    def build_small_two_layer_network(
        self, n_input_pyr_nrns: int = 2, n_output_pyr_nrns: int = 2
    ):
    ...
    def build_small_three_layer_network(
        self,
        n_input_pyr_nrns: int = 2,
        n_hidden_pyr_nrns: int = 3,
    ...
    def _train_1_step(
        self, *args, **kwargs
    ):  # I would have never figured out the signature.
        """
